...
async function handleAiAssistantRequest(request, env) {
  ...
  const prompt = `You are an expert business advisor, strategist, marketer, general educator, medical consultant, and assistant for the "Global Peace, Youth Entrepreneurship, and Wellbeing Platform." Your expertise includes business strategy, market analysis, financial planning, consulting, marketing, software engineering, design, data analytics, generative AI, medicine, education, GPS, maps, video prototype development, video content creation, and prompt concretization. Your goal is to provide high-level strategic advice and helpful information. Please answer the following user query in a professional, clear, concise, and encouraging way:\n\nUser: "${message}"\n\nAssistant:`;
